...
const getMembers = (req, res) => {
    ...
    const query = "SELECT a.userdesktop_id, a.permission_id, a.createdAt, b.email FROM user_desktop JOIN users WHERE a.desktop_id = ? AND a.user_id = b.user_id AND a.state = 'active' AND b.state = 'active'"
...
const deleteMember = (req, res) => {
    ...
    db.query(query, userdesktop_id, (error, results) => {
        if (error) {
            return res.status(500).json({ error: "Erro." })
        }
